import { Sprout, Tractor, Handbag, Warehouse, BetweenVerticalStart, GraduationCap, BadgeIndianRupee, Bus } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div className="w-full aspect-square  bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-4 cursor-pointer">
            <Sprout strokeWidth={1.5} className="w-10 h-10 text-teal-500 mb-3" />
          ...
          <div className="w-full aspect-square bg-white border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-6 cursor-pointer">
          ...
          <div className="w-full aspect-square bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-4 cursor-pointer">
            <Handbag strokeWidth={1.5} className="w-10 h-10 text-teal-500 mb-3" />
          ...
          <div className="w-full aspect-square bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-4 cursor-pointer">
            <Warehouse strokeWidth={1.5} className="w-10 h-10 text-teal-500 mb-3" />
          ...
          <div className="w-full aspect-square bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-4 cursor-pointer">
            <GraduationCap strokeWidth={1.5} className="w-10 h-10 text-teal-500 mb-3" />
          ...
          <div className="w-full aspect-square bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center hover:shadow-md hover:border-teal-500/20 transition p-4 cursor-pointer">
            <Bus strokeWidth={1.5} className="w-10 h-10 text-teal-500 mb-3" />
