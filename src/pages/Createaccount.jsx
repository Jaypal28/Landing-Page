        ...
        <div className="w-full lg:w-2/3 min-h-screen lg:min-h-0 p-6 sm:p-10 md:p-16 flex items-center justify-center bg-white text-slate-900">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                  ...
                  <Link to="/Signin" className="text-blue-500 ml-1">Log in</Link >
                </p>
              </div>

              <select className="border border-slate-200 rounded-md text-slate-800 p-2 bg-white cursor-pointer hover:bg-slate-50 text-sm focus:outline-none">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <Input type="text" placeholder="FullName" className="w-full flex-1" />
              <Input type="text" placeholder="UserName" className="w-full flex-1"/>
            </div>
