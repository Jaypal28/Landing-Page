...
<>
    ...
    <div className="w-1/2 p-10 flex items-center justify-center bg-white text-slate-900">
        ...
        <div className="w-full max-w-md">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <select className="border rounded-md text-white p-2 bg-blue-600 cursor-pointer hover:bg-blue-800">
 ...
 <div className="py-4">
             ...
             <Button
                 onClick={() => navigate("/Verification", { state: { email } })}
                 variant="custom">
                 Create Account
             </Button>
    ...
    <div className="w-1/2 relative overflow-hidden"> 
        ...
        <div className="absolute bottom-12 left-20 flex gap-25 text-white z-10">
